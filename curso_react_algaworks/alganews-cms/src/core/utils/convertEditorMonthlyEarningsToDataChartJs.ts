...
function convertEditorMonthlyEarningsToDataChartJs(editorEarnings: Metric.EditorMonthlyEarnings): ChartProps['data'] {
  const labels: string[] = [];
  const data1: number[] = [];
  const data2: number[] = [];
...
export default convertEditorMonthlyEarningsToDataChartJs;